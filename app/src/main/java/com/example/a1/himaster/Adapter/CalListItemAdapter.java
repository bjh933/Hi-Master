 ...
 */
public class CalListItemAdapter extends BaseAdapter {
    Context context;
    private ArrayList<HashMap<String, String>> mItems;


    public CalListItemAdapter() { mItems = new ArrayList<HashMap<String, String>>(); }

    public CalListItemAdapter(Context context, ArrayList<HashMap<String, String>> list) {  //생성자
    ...
    public View getView(int position, View convertView, ViewGroup parent) {  //출력될 아이템 관리
        ...
        //텍스트 등록
        timeTv.setText(mItems.get(position).get("startTime"));
        planTv.setText(mItems.get(position).get("title"));
